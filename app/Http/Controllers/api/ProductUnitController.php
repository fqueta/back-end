...
class ProductUnitController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Preparar resposta no formato do frontend
        $responseData = [
            'id' => $productUnitToUpdate->ID,
            'label' => $productUnitToUpdate->post_title,
            'value' => $productUnitToUpdate->post_name,
            'active' => $this->decode_status($productUnitToUpdate->post_status),
            'created_at' => $productUnitToUpdate->created_at,
            'updated_at' => $productUnitToUpdate->updated_at,
        ];
