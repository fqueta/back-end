...
class ServiceOrderController extends Controller
{
    ...
    public function update(Request $request, ServiceOrder $serviceOrder): JsonResponse
    {
        ...
        $validator = $this->validateServiceOrder($request, $serviceOrder->id);
        if ($validator->fails()) {
            return response()->json([
                'success' => false,
                'message' => 'Dados inválidos',
    ...
    public function destroy(Request $request, ServiceOrder $serviceOrder): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao mover ordem de serviço para lixeira: ' . $e->getMessage()
            ], 500);
        }
    }
     ...
     */
    private function validateServiceOrder(Request $request, $id = null)
    {
